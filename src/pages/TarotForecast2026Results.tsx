...
const monthsData = [
  { month: "Январь", icon: "❄️", card: "«6 Жезлов»", keywords: "Уверенность • Признание • Успех" },
...
> = {
  Январь: {
    theme: "Январь проходит под знаком уверенности и подтверждения своей позиции. Это месяц, когда становится ясно: что-то уже получилось, усилия были не зря, и можно опираться на достигнутое. Важно признать свои результаты, даже если они кажутся небольшими, и не обесценивать путь, который уже пройден.",
    events: "В делах возможны первые заметные результаты или признание — от других людей или от себя. Хороший момент, чтобы заявить о себе, зафиксировать достижения, показать проделанную работу, взять на себя более заметную роль. Январь поддерживает инициативу и помогает укрепить позицию, особенно если в прошлом были сомнения.",
    opportunities: "Финансовая тема выглядит устойчиво. Возможны поступления или ощущение контроля над деньгами. Это подходящий месяц, чтобы подвести итоги прошлого периода, выстроить уверенный финансовый план, позволить себе небольшое вознаграждение за проделанную работу. Важно не раздувать ожидания, а закреплять стабильность.",
    warnings: "В отношениях появляется больше ясности и уверенности. Это месяц, когда тебя видят и слышат, вклад в отношения становится заметным, легче занимать открытую и честную позицию. Поддержка окружения играет важную роль — не стоит отказываться от неё или пытаться справляться со всем в одиночку.",
    advice: "Обстоятельства складываются благоприятно. Январь даёт ощущение, что мир подыгрывает: появляются подтверждения, отклики, позитивные сигналы. Это не резкие повороты, а скорее мягкое усиление того, что уже было начато ранее.",
    summary: "Главный урок месяца — разрешить себе чувствовать уверенность. 6 Жезлов учит: принимать признание, не занижать свою ценность, опираться на успехи как на ресурс, начинать год не с сомнений, а с опоры. Январь помогает задать тон всему году — через уверенность, а не через давление на себя.",
  },
  Февраль: {
          ...
          >
            ...
            <div className="space-y-5">
              <div className="interpretation-item" style={{ animationDelay: "50ms" }}>
                <p className="text-white font-semibold text-sm mb-1">🎯 Главная тема</p>
              ...
              <div className="interpretation-item" style={{ animationDelay: "100ms" }}>
                <p className="text-white font-semibold text-sm mb-1">💼 Работа и проекты</p>
              ...
              <div className="interpretation-item" style={{ animationDelay: "150ms" }}>
                <p className="text-white font-semibold text-sm mb-1">💰 Финансы</p>
              ...
              <div className="interpretation-item" style={{ animationDelay: "200ms" }}>
                <p className="text-white font-semibold text-sm mb-1">❤️ Отношения и окружение</p>
              ...
              <div className="interpretation-item" style={{ animationDelay: "250ms" }}>
                <p className="text-white font-semibold text-sm mb-1">🌍 Внешние обстоятельства</p>
              ...
              <div className="interpretation-item" style={{ animationDelay: "300ms" }}>
                <p className="text-white font-semibold text-sm mb-1">🌱 Урок / точка роста</p>
